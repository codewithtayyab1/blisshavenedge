...
export const FEATURED_SERVICES = [
  { id: 1, name: "Hair Cutting & Styling", category: "HAIR" },
  { id: 2, name: "Facials", category: "SKIN" },
  { id: 3, name: "Hair Treatments", category: "TREATMENT" },
];
...
export const SERVICE_CATEGORIES = [
  {
    ...
    description:
      "From sharp fades to timeless classic cuts, our barbers shape every style to suit your face and personality. Finished with precision and a clean styling touch — you walk out looking your absolute best.",
    services: [
  ...
  },
  {
    ...
    description:
      "Revive tired, damaged hair with our professional treatments. From deep protein therapy to high-shine finishing, we use trusted products to strengthen, smooth, and restore your hair's natural health.",
    services: [
  ...
  },
  {
    ...
    name: "Facials",
    description:
      "Refresh and rejuvenate your skin with facials tailored to your needs — brightening, hydrating, and deep-cleansing. Walk out with skin that looks clean, even-toned, and visibly healthier.",
    services: [
  ...
  },
  {
    ...
    name: "Cleansing",
    description:
      "A quick, professional reset for your skin. Our deep-cleansing treatments clear away dirt and dullness, leaving you looking fresh and feeling sharp.",
    services: [
  ...
  },
  {
    ...
    description:
      "Natural, long-lasting colour for hair and beard using premium L'Oréal and Keune ranges. Matched to your tone and applied evenly for a clean, confident finish.",
    services: [
  ...
  },
  {
    ...
    name: "Wax & Cleaning",
    description:
      "Smooth, hygienic grooming for face and body, handled by experienced staff — quick, clean, and comfortable.",
    services: [
  ...
  },
  {
    ...
    name: "Massage & Care",
    description:
      "Relax and recharge with our massage and care services — from head and shoulder relief to full manicure and pedicure. The perfect way to unwind after your grooming session.",
    services: [
...
export const DEALS = [
  ...
  {
    id: 6,
    name: "Groom Package (3 Days)",
    desc: "Hair Cut x2, Beard Shave x3, Facial (Steam) x3, Face Makeup x3, Hair Styling x3, Hair Shiner, Face Cleansing, Nose Strip, Face Wax, Face Wash, Head Wash.",
    includes: [
      "Hair Cut (2x)",
      "Beard Shave (3x)",
      "Facial Steam (3x)",
...
export const GALLERY_IMAGES = [
  ...
  })),
  {
    ...
    category: "interior",
    alt: "Bliss Haven Edge men's salon interior, Wah Cantt",
  },
  {
    id: 13,
    src: "/images/interior-2.jpeg",
    category: "interior",
    alt: "Bliss Haven Edge premium grooming lounge, Wah Cantt",
  },
  {
    id: 14,
    src: "/images/interior-3.jpeg",
    category: "interior",
    alt: "Barber station at Bliss Haven Edge salon, Wah Cantt",
  },
  {
    id: 15,
    src: "/images/interior-4.jpeg",
    category: "interior",
    alt: "Relaxed grooming space at Bliss Haven Edge, Wah Cantt",
  },
  {
    id: 16,
    src: "/images/interior-7.jpeg",
    category: "interior",
    alt: "Bliss Haven Edge salon ambiance, Laiq Ali Chowk, Wah Cantt",
  },
  {
    id: 19,
    src: "/images/exterior-1.jpeg",
    category: "interior",
    alt: "Bliss Haven Edge salon exterior, CB Shop No 2, Wah Cantt",
  },
];
...
export const GALLERY_VIDEOS = [
  {
    id: 0,
    src: "/videos/transform-5.mp4",
    title: "Haircut Transformation",
    category: "TRANSFORMATION",
  },
  {
    id: 1,
    src: "/videos/transform-1.mp4",
    title: "The Ritual of Grooming",
    category: "TRANSFORMATION",
  },
  {
    id: 2,
    src: "/videos/transform-2.mp4",
    title: "The Art of Scissor Cutting",
    category: "SCISSOR CRAFT",
  },
  {
    id: 3,
    src: "/videos/transform-6.mp4",
    title: "The Perfect Perm",
    category: "HAIR PERM",
  },
  {
    id: 4,
    src: "/videos/groom-1.mp4",
    title: "The Complete Groom",
    category: "GROOMING",
  },
  {
    id: 5,
    src: "/videos/groom-2.mp4",
    title: "The Grooming Experience",
    category: "GROOMING",
  },
];
